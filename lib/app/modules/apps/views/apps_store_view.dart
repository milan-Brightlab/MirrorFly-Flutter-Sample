...
import '../../chat/widgets/notification_message_view.dart';
...
class AppsSearchView extends StatelessWidget {

  AppsSearchView({super.key});
          ...
          appBar: AppBar(
           ...
           body: Stack(
             children: [
                   ...
                   return ListTile(
                     leading: Container(
                       ...
                       decoration: BoxDecoration(
                         color: installedapps[index].color,
                         borderRadius: BorderRadius.circular(10),
                       ),
                       child: Icon(installedapps[index].iconPath, color: Colors.white),
                     ),
                     title: Text(
                       installedapps[index].title,
                       style: TextStyle(fontWeight: FontWeight.bold),
                     ),
                     subtitle: Text(installedapps[index].title), // Make sure to add subtitle to your AppModel
                     onTap: () {
               ...
               // You can add more overlaying widgets here if needed
             ],
           )
